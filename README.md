...
The numpy array representing the track can be regenerated by calling the script

```bash
ptyhon scripts/generate_track.py
```

You might edit the script to change the resolution of the waypoints,
meaning the distance between two points.
Currently, it is fixed to 10cm.
